...
$$
\frac{\partial}{\partial w_8} MSE(y, \hat{y}) = \frac{\partial}{\partial \hat{y_2}} MSE(y_2, \hat{y_2}) \times \frac{\partial}{\partial (w_{11} g_{1} + w_{12} g_2 + b_6) } \hat{y_2} \times \frac{\partial}{\partial w_{12}} (w_{11} g_{1} + w_{12} g_2 + b_6)
$$

$$
\times \frac{\partial}{\partial (w_{7} h_{1} + w_{8} h_2 + b_4)} g_2 \times \frac{\partial}{\partial w_8} (w_{7} h_{1} + w_{8} h_2 + b_4)
$$
